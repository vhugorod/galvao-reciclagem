...
class TH_StaticContentShowroomCarousel extends ZnElements
{
	...
	function element()
	{
		...
		?>
		<div class="kl-slideshow static-content__slideshow sc--showroom-carousel <?php echo esc_attr( $style ); ?> <?php echo esc_attr( $uid ); ?> <?php echo esc_attr( $bm_class ); ?> <?php echo zn_get_element_classes($this->data['options']); ?>">
			...
			<div class="kl-slideshow-inner static-content__wrapper <?php echo esc_attr( $static_content_fullscreen ); ?> <?php echo esc_attr( $static_content_height ) ?>">
				...
				<div class="static-content__inner container">
					<div class="kl-slideshow-safepadding  sc__container <?php echo esc_attr( $obj_parallax__class ); ?>" <?php echo esc_attr( $obj_parallax__attribs ); ?>>
...
if ( isset ( $options['single_shcar'] ) && is_array( $options['single_shcar'] ) ):
	...
	$with_nav_class = $has_nav ? 'with-nav' : '';
	?>

	<div class="shcar__nav_pag <?php echo esc_attr( $with_nav_class ); ?>">
