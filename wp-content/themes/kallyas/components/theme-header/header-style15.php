...
/**** MAIN LEFT */
add_action( 'zn_head__main_left', 'zn_header_main_menu' ); // MAIN NAVIGATION
...
/**** MAIN RIGHT */
add_action( 'zn_head__main_right', 'zn_header_searchbox_bord' ); // search box
