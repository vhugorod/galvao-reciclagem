...
class TH_StaticContentTextAndRegister extends ZnElements
{
	...
	function element()
	{
		...
		?>
<div class="kl-slideshow static-content__slideshow nobg <?php echo esc_attr( $uid ); ?> <?php echo esc_attr( $bm_class ); ?> <?php echo zn_get_element_classes($this->data['options']); ?>">
		...
		<div class="static-content__inner container">
			...
			<div class="kl-slideshow-safepadding  sc__container <?php echo esc_attr( $obj_parallax__class ); ?>" <?php echo $obj_parallax__attribs; ?>>
				...
				<div class="static-content default-style static-content--with-login">
					...
					<div class="row">
						<div class="<?php echo esc_attr( $section_1_class );?>">
							<?php
						...
						<div class="col-sm-10 col-sm-offset-1 col-md-5 col-md-offset-0">
							<div class="fancy_register_form">
								...
								<form name="login_form"
									...
									if ( znhgReCaptchaEnabled() ) {
										...
										echo '<div class="form-group">';
											...
											if ( empty( $siteKey ) || empty( $pvKey ) ) {
												...
												echo '<div class="kl-recaptcha" data-colorscheme="' . esc_attr( $color_scheme ) . '" data-sitekey="' . esc_attr( $siteKey ) . '" id="zn_recaptcha_elem-registration"></div>';
											}
										echo '</div>';

									}

									do_action( 'kallyas_register_form_end' ); ?>
									...
									<input type="hidden" value="<?php echo esc_url( $current_url) ;?>" class="zn_login_redirect" name="submit"/>
