...
$admin_options[]         = array (
    ...
    "description" => sprintf(__( 'Here you can add colors that will be displayed in the <strong style="color:#121212">bottom\'s colorpicker palette</strong>:<br><br> <img width="140" src="%s/images/zn_add_pallette_lq.png">. <br><br>Color resources:', 'zn_framework' ), THEME_BASE_URI) .'<br><a href="'.esc_url('http://colorhunt.co/tab/').'">ColorHunt</a><br><a href="'.esc_url('http://www.colourlovers.com/').'">ColourLovers</a>',
    "id"          => "zn_add_colors",
    "std"         => "",
    "type"        => "group",
