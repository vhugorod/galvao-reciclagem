...
if(zn_check_components('header_nav')) add_action( 'zn_head__top_right', 'zn_add_navigation', 30 ); // HEADER NAVIGATION
...
add_action( 'zn_head__main_right', 'zn_woocomerce_cart_init', 5 ); // CART PANEL
