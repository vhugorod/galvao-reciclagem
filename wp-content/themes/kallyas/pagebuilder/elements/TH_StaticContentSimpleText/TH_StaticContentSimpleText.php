...
<div class="kl-slideshow static-content__slideshow static-simpletext nobg <?php echo esc_attr( $uid ); ?> <?php zn_the_element_classes($this->data['options']); ?>">
	...
	<?php
		...
		$sc_fadeboxed = $this->opt( 'sc_fadeboxed', '0' ) ? 'sc--has-fade-mask' : '';
	?>
	<div class="kl-slideshow-inner static-content__wrapper <?php echo esc_attr( $static_content_fullscreen ); ?> <?php echo esc_attr( $static_content_height ); ?> <?php echo esc_attr( $sc_fadeboxed ); ?>">
		...
		<div class="static-content__inner container">
			...
			<div class="kl-slideshow-safepadding sc__container <?php echo esc_attr( $obj_parallax__class ); ?>" <?php echo $obj_parallax__attribs; ?>>
				...
				<div class="static-content static-content--simple scs--theme-<?php echo esc_attr( $this->opt('sc_text_theme', 'grayish') ); ?>">
					<div class="row">
						<div class="col-sm-12">
							<?php
