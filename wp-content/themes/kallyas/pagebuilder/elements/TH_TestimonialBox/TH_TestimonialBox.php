...
';
	...
	function element()
	{
		...
		?>
			...
			<div class="testimonial_box tst-box tb-<?php echo esc_attr( $uid ); ?> clearfix <?php echo esc_attr( $cssClass );?> <?php echo zn_get_element_classes($options); ?>" data-align="<?php echo esc_attr( $align );?>" data-theme="<?php echo esc_attr( $style );?>" <?php echo zn_get_element_attributes($options); ?>>
