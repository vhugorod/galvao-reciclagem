...
$admin_options[] = array (
	...
	"subelements"    => array (
		array (
			...
			"description" => __( "The name of this header style.Please note that all names must be unique. You can only use alphanumeric characters. Other character types can cause problems.", 'zn_framework' ),
			"id"          => "uh_style_name",
			"std"         => '',
			"type"        => "text",
			'supports'    => 'block'
...
$admin_options[] = zn_options_video_link_option( 'https://my.hogash.com/video_category/kallyas-wordpress-theme/#6T0VYHCS9mA', __( "Click here to access the video tutorial for this section's options.", 'zn_framework' ), array(
	'slug'        => 'unlimited_header_options',
	'parent'      => 'unlimited_header_options'
));
