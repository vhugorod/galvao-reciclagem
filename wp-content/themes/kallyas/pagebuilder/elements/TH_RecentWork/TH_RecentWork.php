...
<div class="recentwork_carousel <?php echo implode(' ', $elm_classes); ?> clearfix" <?php zn_the_element_attributes($options); ?>>

	<div class="row">

		<div class="col-sm-<?php echo esc_attr( $col_left ); ?>">
		...
		<div class="col-sm-<?php echo esc_attr( $col_right ); ?>">
