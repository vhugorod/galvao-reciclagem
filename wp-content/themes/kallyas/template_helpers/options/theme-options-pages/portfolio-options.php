...
$admin_options[] = array(
	'slug'        => 'portfolio_options',
	'parent'      => 'portfolio_options',
	"name" => __("Display portfolio items media on search pages?", 'zn_framework'),
	"description" => __("If this option is enable the portfolio items media will be visible on search page", 'zn_framework'),
	"id" => "show_search_medias",
	"std" => "no",
	"options" => array(
		'yes' => __('Show', 'zn_framework'),
		'no' => __('Hide', 'zn_framework'),
...
$admin_options[] = array(
	'slug'        => 'portfolio_options',
	'parent'      => 'portfolio_options',
	"name" => __("Show portfolio tags?", 'zn_framework'),
	"description" => __("Here, you can choose to show the portfolio tags or not.", 'zn_framework'),
	"id" => "ports_show_tags",
	"std" => "no",
	"options" => array(
		'yes' => __('Show', 'zn_framework'),
...
$admin_options[] = zn_options_video_link_option( 'https://my.hogash.com/video_category/kallyas-wordpress-theme/#rVA576HZaYA', __( "Click here to access the video tutorial for this section's options.", 'zn_framework' ), array(
	'slug'        => 'portfolio_options',
	'parent'      => 'portfolio_options'
));
$admin_options[] = zn_options_doc_link_option( 'https://my.hogash.com/documentation/setting-up-portfolio/', array(
	'slug'        => 'portfolio_options',
	'parent'      => 'portfolio_options'
));
