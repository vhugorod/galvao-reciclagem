 ...
 *
 * All form fields are set in this array: $ZnContactFormFieldsArray;
 *
 ...
 *
 * 	- All Contact Form fields will be found in this array: $ZnContactFormFieldsArray, as fieldName => field value
 ...
 */
if( ! empty( $ZnContactFormFieldsArray ) ){
	foreach( $ZnContactFormFieldsArray as $fieldName => $fieldValue ){
