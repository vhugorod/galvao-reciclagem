...
/**
* Display the Style 16 header
* Hooks mostly, markup loaded through own template
*/

/**
 * ==========================================================
 * CSS custom classes customizations
 * ==========================================================
 */
...
$flexbox_scheme = array(
    'main' => array(
        'left' => array(
            'stretch' => 'fxb-basis-50',
        ),
        'center' => array(
            'stretch' => 'fxb-basis-auto fxb-shrink-0 fxb-sm-full',
        ),
        'right' => array(
            'stretch' => 'fxb-basis-50',
        ),
...
if(zn_check_components('social_icons')) add_action( 'zn_head__top_left', 'zn_header_social_icons' ); // SOCIAL ICONS
if(zn_check_components('custom_text')) add_action( 'zn_head__top_left', 'zn_header_head_text' ); // CUSTOM TEXT
...
/**** MAIN LEFT */
add_action( 'zn_head__main_left', 'zn_mainmenu_active_text' ); // MAIN NAVIGATION
...
/**** MAIN RIGHT */
add_action( 'zn_head__main_right', 'zn_header_searchbox_bord2' ); // search box
add_action( 'zn_head__main_right', 'zn_woocomerce_cart_init' ); // CART PANEL
// add_action( 'zn_head__main_right', 'zn_header_calltoaction' ); // CALL TO ACTION BUTTON

/**** OTHERS */
add_action( 'zn_head__after__main', 'zn_header_separator' ); // Add separator after top
